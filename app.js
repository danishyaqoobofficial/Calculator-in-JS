...
inputNumber.addEventListener('keyup', (e) =>{
    if (e.keyCode === 13) {
        if (inputNumber.value === '') {
            ...
            Error.innerHTML = ''
            if (inputNumber.value <= 120 && inputNumber.value > 0 ) {
                one.classList.add('!text-[#000]')
            }else if (inputNumber.value <= 240 && inputNumber.value > 121 ) {
                two.classList.add('!text-[#000]')
            }else if (inputNumber.value <= 360 && inputNumber.value > 241 ) {
                three.classList.add('!text-[#000]')
            }else{
                one.classList.remove('!text-[#000]')
                two.classList.remove('!text-[#000]')
                three.classList.remove('!text-[#000]')
            }
        }
    }else{
